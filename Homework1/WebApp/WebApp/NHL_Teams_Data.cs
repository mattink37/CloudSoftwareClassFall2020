...
namespace WebApp.wwwroot
{
  ...
  {
    //private const Dictionary<string, string> sortStatus = new Dictionary<string, string>();
    ...
    public NHL_Teams_Data(string json)
    {
      ...
      nameList.Add("Seattle Kraken");
      firstYearOfPlayList.Add(2021);
    }

    public static void SortTeamsByAscendingFirstYearOfPlay()
    {
      if (sortStatus != "Sorted by ascending first year of play")
      {
        if (sortStatus == "Sorted by descending first year of play")
        {
          nameList.Reverse();
          firstYearOfPlayList.Reverse();
        }
        else
        {
        ...
        sortStatus = "Sorted by ascending first year of play";
      }
    }
    public static void SortTeamsByDescendingFirstYearOfPlay()
    {
      if (sortStatus != "Sorted by descending first year of play")
      {
        if (sortStatus == "Sorted by ascending first year of play")
      ...
      sortStatus = "Sorted by descending first year of play";
    }
  }
}
